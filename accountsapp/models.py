...
class ProfileChild(models.Model):
    ...
    nama_lengkap = models.CharField(max_length=200, blank=True, null=True)  # Nama Lengkap Anak
    umur = models.PositiveIntegerField(blank=True, null=True)  # Umur
    PILIHAN_PENDIDIKAN = [
    ...
    pendidikan = models.CharField(max_length=20, choices=PILIHAN_PENDIDIKAN, blank=True, null=True)  # Pilihan Pendidikan
    BIDANG_MINAT = [
        ('olahraga', 'Olahraga'),
        ('berhitung', 'Berhitung'),
    ]
